...
Improved: Enhanced the URL controller UI for improved usability and consistency.

2.5.4 - 24 June 2026
New: Added 10+ new controllers to the Gutenberg Core Builder, expanding design and content-building capabilities.
Improved: Enhanced the AI Template import workflow for a smoother, faster, and more reliable import experience.

2.5.3 - 18 June 2026
Fixed: Minor Bug Fixes & Improvements.

2.5.2 - 10 June 2026
Improved: Cross Domain Copy Paste Prevent unavailable widgets to paste
Fixed: Minor Bug Fixes & Improvements.

2.5.1 - 05 June 2026
Added: Auto download of WDesignKit widgets during cross-domain copy & paste.
Improved: Language translation in cross-domain copy & paste feature.
Improved: Product Abilities
Fixed: Minor Bug Fixes & Improvements.
...
Fixed: Resolved issue with Nexter Blocks widget download.
Fixed: Minor Bug Fixes & Improvements.

2.3.0 - 1 May 2026
New : Download WDesignKit While Template Import.
Fixed: Minor Bug Fixes & Improvements.

2.2.10 - 23 March 2026
Improved: Import Products during WooCommerce Kit import.
New : Add New Image Library support in AI Kit import.
Fixed: Site logo update issue in Elementor AI Kit import flow.
Fixed: Navigation menu link update issue in Kit import.
Fixed: Minor Bug Fixes & Improvements.

2.2.9 - 05 March 2026
Fixed: Gutenberg AI imported content not rendering on the frontend.
Fixed: Error when importing AI-generated block posts.
Fixed: Page import error caused by invalid JSON during AI Kit import.
Improved: Final loading page design in the Kit import process.
Improved: Plugin installation retry process.
Fixed: Minor Bug Fixes & Improvements.
...
Improved: Search bar for AI image selection in AI Kit import.
Improved: Add tooltips to every step for better understanding of the AI Import flow.
Fixed: Page template and section auto-linking issue after import.
Fixed: Minor Bug Fixes & Improvements.
